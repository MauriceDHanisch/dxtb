...
def scf_wrapper(
    ...
    **kwargs: Any,
    ...
    config.fwd_options = {
        ...
        "damp_dynamic": config.damp_dynamic,
        "damp_dynamic_factor": config.damp_dynamic_factor,
        "damp_generations": config.damp_generations,
        "damp_soft_start": config.damp_soft_start,
        "f_tol": config.f_atol,
        "x_tol": config.x_atol,
        "x_tol_max": config.x_atol_max,
        "f_rtol": float("inf"),
        "x_rtol": float("inf"),
